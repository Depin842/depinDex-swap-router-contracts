...
import 'depin-dex-v3-periphery/contracts/base/PeripheryImmutableState.sol';
...
import 'depin-dex-v3-periphery/contracts/libraries/Path.sol';
import 'depin-dex-v3-periphery/contracts/libraries/PoolAddress.sol';
import 'depin-dex-v3-periphery/contracts/libraries/CallbackValidation.sol';
...
/// @title Provides on chain quotes for depindex, V2, and MixedRoute exact input swaps
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IDepinDexSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IDepinDexPool;
    address public immutable factoryV2;
    /// @dev Value to bit mask with path fee to determine if V2 or depindex route
    // max depindex fee:           000011110100001001000000 (24 bits)
    ...
    /// @dev Fetch an exactIn quote for a depindex Pool on chain
    ...
    /// @dev Get the quote for an exactIn swap between an array of V2 and/or depindex pools
